...
public class StringToolsTest {
  ...
  private static final String NEW_STRING = "This is" + INSERT_THIS + " the original string.";
  ...
  private static final String COMPLEX_PALINDROME =
      "Doc Note: I dissent!  A fast never prevents a fatness.  I diet on cod?";

  private static final String NOT_PALINDROME = ORIGINAL_STRING;

  private static final String FAIL = "Insert failed.";

  @Test
  public void insertStringTest() {
    final StringTools theTools = new StringTools();
    final String newString = theTools.insertString(INSERT_THIS, ORIGINAL_STRING, AT_HERE);

    assertEquals(FAIL, NEW_STRING, newString);
  }

  @Test
  public void insertStringAppendTest() {
    final StringTools theTools = new StringTools();
    final String newString = theTools.insertString(INSERT_THIS, ORIGINAL_STRING, BEYOND_END);

    assertEquals(FAIL, BEYOND_STRING, newString);
  }

  @Test
  public void insertStringNegativeTest() {
    final StringTools theTools = new StringTools();
    final String newString = theTools.insertString(INSERT_THIS, ORIGINAL_STRING, NEGATIVE_INDEX);

    assertEquals(FAIL, NEGATIVE_STRING, newString);
  }

  @Test
  public void insertNullTest1() {
    final StringTools theTools = new StringTools();
    final String newString = theTools.insertString(null, ORIGINAL_STRING, AT_HERE);

    assertEquals(FAIL, ORIGINAL_STRING, newString);
  }

  @Test
  public void insertNullTest2() {
    final StringTools theTools = new StringTools();
    final String newString = theTools.insertString(null, ORIGINAL_STRING, BEYOND_END);
  ...
  public void insertNullTest3() {
    final StringTools theTools = new StringTools();
    final String newString = theTools.insertString(null, ORIGINAL_STRING, NEGATIVE_INDEX);
