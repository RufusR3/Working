...
public class NumberTools {
    ...
    /***************************************************************************
     * Given a three digit number, determine if the sum of the cubes of each
	...
	if (theNumber >= 0 && theNumber <= 999) {
	    ...
	    final int theSum = (int) ((Math.pow(firstDigit, 3))
    ...
    /***************************************************************************
     * Main method to print out the three digit numbers where the sum of the
     * cubes of each digit is equal to the number itself.
     * 
     * @param args
     *            Not used
     **************************************************************************/
