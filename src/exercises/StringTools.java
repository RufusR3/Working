...
public class StringTools {
   ...
   * 
   * @param insertThis The string to insert.
   * @param intoThis The string to insert into.
   * @param atHere The position within intoThis to insert insertThis.
   * @return
   */
  public String insertString(final String insertThis, final String intoThis, final int atHere) {
    ...
    try {
      /**
       * If the string to insert is null, then the original string doesn't change.
       */
      if (insertThis != null) {
      ...
      /**
       * If we are out-of-bounds due to an insertion beyond the size, just append.
       */
      ...
      /**
       * If we are out-of-bounds due to a negative index, just insert at the beginning
       */
      else {
   ...
   * 
   * @param theString The string to remove the punctuation from.
   * @return
   */
   ...
   * 
   * @param theString String to test if is a palindrome.
  ...
  public boolean isPalindrome(final String theString) {
    ...
    if ("".equals(theString) || theString == null) {
      ...
      final String noPunctuation = removePunctuation(theString).toLowerCase(Locale.US);
      final StringBuilder reversedString = new StringBuilder(noPunctuation);
